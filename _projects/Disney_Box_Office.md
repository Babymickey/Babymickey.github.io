...
Have you ever wondered how Disney has become the Movie giant it is today? I have. Since the release of Snow White in 1937, Disney has transitioned from a niche animation studio into a global media powerhouse. This evolution is most visible when looking at Disney movies after the ‘Disney Renaissance Era’. What began as a sporadic release schedule transformed into a dominant boom, eventually leading to the current movie power house it is today.

<br>
### Evolution of Disney
To understand this evolution, we can first look at the sheer volume and timing of their releases. The scatter plot below serves as my primary evidence for Disney’s growth. Notice how the clusters got larger over time: while Disney was once without clear focus in movies, their strategy shifted to focused toward “Action”, "Drama", and “Adventure” as the 21st century approached. This wasn’t accidental, Disney has narrowed its focus onto genres with the highest global appeal, especially focusing on Adventure and Action franchises.

{% include vegachart.html path="assets/json/main_color_chart.json" %}

<br>
### Success: Genre vs. Market
Now, to address why this genre shift occurred, I thought it was important to see why that occurred. The chart below shows the average gross income of each Disney genre. 
