...
{% include vegachart.html path="assets/json/disney_main.json" %}


### Strategy by Genre: What makes the most?
When its broken down by genre, you may begin to pck up on Disney’s strategy. While “Musical”, “Drama” and “Comedy” defined the studios early identity and remains a high-preforming category, “Adventure”, “Action” and “Drama” have become the primary drivers of Disney in the modern era. This shift suggests that DIsney has moved toward elaborat, broad-appeal movies, that can perform well in the international market as well. By looking at the average gross per genre in the chart below, it becomes clear why the studio focuses on adventure sagas.

{% include vegachart.html path="assets/json/disney_genre.json" %}


### THe Impact of Renessiance Era?
To understand Disney’s modern dominance, its important to look back at the “Renaissance Era”, between 1989 and 1999. After stagnation in the 1980s, this decade saw a string of massive hits, starting with “The Little Mermaid” and peaking at “The Lion King”, which revitalized the disney brand. The chart below highlights the top performers from the renaissance era, showcasing how Disney reclaimed the box office and set the stage for their current height. These films developed the nostalgia of Disney, that allowed Disney to leverage this for the current live-action remakes.

{% include vegachart.html path="assets/json/renaissance_chart.json" %}
